...
static struct BurnRomInfo kovlsyxBiosRomDesc[] = {
	{ "pgm_t01s.rom",				0x0200000, 0x1a7123a0, BRF_GRA | BRF_BIOS }, 	// 0x80 - 8x8 Text Layer Tiles
	{ "lsyx_m01s.rom",				0x0200000, 0x81a6aeca, BRF_SND | BRF_BIOS },	// 0x81 - Samples
...
static struct BurnRomInfo olds100RomDesc[] = {
	...
	{ "sp_v100_u6.u6",				0x0010000, 0xe7613dda, 9 | BRF_PRG | BRF_ESS },  // 19 Protection Rom
...
static struct BurnRomInfo olds100aRomDesc[] = {
	...
	{ "sp_data.u6",					0x0010000, 0xe7613dda, 9 | BRF_PRG | BRF_ESS },	// 15 Protection Rom

#if defined (ROM_VERIFY)
	{ "ram_dump",					0x0040000, 0x280cfb4e, 0 | BRF_OPT },			// 16 Dump of RAM shared with protection device
#endif
};
...
#if !defined ROM_VERIFY
	{ "gsyx_prot.c51",				0x0010000, 0x8598d603, 7 | BRF_PRG | BRF_ESS | BRF_NODUMP }, //  7 Internal ARM7 Rom
#else
...
struct BurnDriver BurnDrvkovqhsgsa = {
	...
	"Quanhuang Sanguo Tebie Ban (bootleg of Knights of Valour Super Heroes, V303CN alt, China)\0", NULL, "IGS", "PolyGame Master",
...
struct BurnDriver BurnDrvkovqhsgsd = {
	...
	"Quanhuang Sanguo Tebie Ban (bootleg of Knights of Valour Super Heroes, V303CN, China, decrypted version)\0", NULL, "IGS", "PolyGame Master",
...
struct BurnDriverD BurnDrvkovlsqh = {
	...
	"Luanshi Quanhuang (bootleg of Knights of Valour Super Heroes Plus, ver. 200CN)\0", "Incomplete dump", "bootleg", "PolyGame Master",
...
struct BurnDriver BurnDrvkovlsqho = {
	...
	"Knights of Valour: Luan Shi Quan Huang Te Bie Ban / Sangoku Senki: Luan Shi Quan Huang Te Bie Ban (V112CN, China)\0", "Incomplete dump", "IGS", "PolyGame Master",
...
struct BurnDriverD BurnDrvkovlsjb = {
	...
	"Luanshi Jie Ba (bootleg of Knights of Valour Super Heroes Plus, ver. 200CN, set 1)\0", NULL, "bootleg", "PolyGame Master",
...
struct BurnDriverD BurnDrvkovlsjba = {
	...
	"Luanshi Jie Ba (bootleg of Knights of Valour Super Heroes Plus, ver. 200CN, set 2)\0", "Incomplete dump", "bootleg", "PolyGame Master",
...
// Knights of Valour: Ao Shi Sanguo Plus / Sangoku Senki: Ao Shi Sanguo Plus (V315CN, China)
...
struct BurnDriverD BurnDrvkovassgplus = {
	...
	"Knights of Valour: Ao Shi Sanguo Plus / Sangoku Senki: Ao Shi Sanguo Plus(V315CN, China)\0", "Incomplete dump", "IGS", "PolyGame Master",
	L"Knights of Valour: Ao Shi Sanguo Plus\0\u4E09\u56FD\u6218\u7EAA\0\u50B2\u4E16\u4E09\u56FD Plus (V315CN, China)\0", NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG, 4, HARDWARE_IGS_PGM /* | HARDWARE_IGS_USE_ARM_CPU */, GBF_SCRFIGHT, 0,
...
// Knights of Valour: Ao Shi Sanguo / Sangoku Senki: Ao Shi Sanguo (V202CN, China)
...
struct BurnDriver BurnDrvkovassg = {
	...
	"Knights of Valour: Ao Shi Sanguo / Sangoku Senki: Ao shi Sanguo (V202CN, China)\0", "Imperfect Protection Emulation", "IGS", "PolyGame Master",
...
// Knights of Valour: Ao Shi Sanguo / Sangoku Senki: Ao Shi Sanguo (Encrypted, V202CN, China)
/* VER: V202CN
   DATE: OCT 6 2008
   TIME: 09:59:26 */
...
struct BurnDriver BurnDrvkovassge = {
	...
	"Knights of Valour: Ao Shi Sanguo / Sangoku Senki: Ao shi Sanguo (Encrypted, V202CN, China)\0", "Imperfect Protection Emulation", "IGS", "PolyGame Master",
...
// Knights of Valour: Ao Shi Sanguo / Sangoku Senki: Ao Shi Sanguo (Newer, V202CN, China)
/* VER: V202CN
   DATE: OCT 6 2008
   TIME: 09:59:26 */
...
struct BurnDriver BurnDrvkovassgn = {
	...
	"Knights of Valour: Ao Shi Sanguo / Sangoku Senki: Ao shi Sanguo (Newer, V202CN, China)\0", "Imperfect Protection Emulation", "IGS", "PolyGame Master",
...
struct BurnDriver BurnDrvKovsgqyz = {
	...
	"Sanguo Qunying Zhuan Zhengzong Plus (bootleg of Knights of Valour Plus, set 1)\0", NULL, "bootleg", "PolyGame Master",
...
struct BurnDriver BurnDrvKovsgqyza = {
	...
	"Sanguo Qunying Zhuan Zhengzong Plus (bootleg of Knights of Valour Plus, set 2)\0", NULL, "bootleg", "PolyGame Master",
...
struct BurnDriver BurnDrvKovsgqyzb = {
	...
	"Sanguo Qunying Zhuan Zhengzong Plus (bootleg of Knights of Valour Plus, set 3)\0", NULL, "bootleg", "PolyGame Master",
...
struct BurnDriver BurnDrvKovsgqyzc = {
	...
	"Sanguo Qunying Zhuan Zhengzong Plus (bootleg of Knights of Valour Plus, set 4)\0", NULL, "ANX", "PolyGame Master",
...
struct BurnDriver BurnDrvKovsgqyzd = {
	...
	"Knights of Valour: SanGuo QunYingZhuan / Sangoku Senki: SanGuo QunYingZhuan (V119, set 5)\0", NULL, "ANX", "PolyGame Master",
...
struct BurnDriver BurnDrvKov2pfwll = {
	...
	"Sanguo Zhan Ji 2 Fengwu Longyin (ver. 205S, , Hack of Sanguo Zhan Ji 2 Qunxiong Zhengba)\0", NULL, "Hack", "PolyGame Master",
...
struct BurnDriver BurnDrvkov2pfwlys = {
	...
	"Sanguo Zhan Ji 2 Fengwu Longyin (ver. S0709, Hack of Sanguo Zhan Ji 2 Qunxiong Zhengba)\0", NULL, "Hack", "PolyGame Master",
...
struct BurnDriver BurnDrvOrlegndcbbws = {
	"orlegndchack", "orlegend", "pgm", NULL, "2017-02-15",
...
struct BurnDriver BurnDrvOrlegndcqpgj = {
	"orlegndchack", "orlegend", "pgm", NULL, "2017-03-07",
...
struct BurnDriver BurnDrvOrlegndcyxgl = {
	"orlegndchack", "orlegend", "pgm", NULL, "2020-07-25",
...
static struct BurnRomInfo orlegendcxstyRomDesc[] = {
	{ "xsty-p0101.rom",	0x0200000, 0x91923b5a, 1 | BRF_PRG | BRF_ESS },
...
STDROMPICKEXT(orlegendcxsty, orlegendcxsty, pgm)
STD_ROM_FN(orlegendcxsty)

struct BurnDriver BurnDrvOrlegendcxsty = {
	"orlegendcxsty", "orlegend", "pgm", NULL, "2017-03-07",
	"Oriental Legend (Meng Hui Xun Xian)\0", NULL, "IGS", "PolyGame Master",
	L"\u897F\u6E38\u91CA\u5384\u4F20 - \u643A\u624B\u5929\u6DAF [2017-03-07]\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM, GBF_SCRFIGHT, 0,
	NULL, orlegendcxstyRomInfo, orlegendcxstyRomName, NULL, NULL, NULL, NULL, pgmInputInfo, orlegendDIPInfo,
	orlegendInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};
...
struct BurnDriver BurnDrvOlds100aemqs2017 = {
	"olds100ahack", "olds100a", "pgm", NULL, "2021-12-16",
...
struct BurnDriver BurnDrvOlds100aremix = {
	"olds100ahack", "olds100a", "pgm", NULL, "2017-03-07",
...
struct BurnDriver BurnDrvOlds100aremixp = {
	"olds100ahack", "olds100a", "pgm", NULL, "2018-09-27",
	"Oriental Legend Special - Remix\0", NULL, "IGS", "PolyGame Master",
...
static struct BurnRomInfo olds100awxcststwRomDesc[] = {
	...
	{ "pgm_a0504.u11",		0x0400000, 0x45337583, 3 | BRF_GRA },
	{ "pgm_a0505.u12",		0x0400000, 0x5b8cf3a5, 3 | BRF_GRA },
	{ "wxcststw-a0506.rom",	0x0800001, 0x55cb36c9, 3 | BRF_GRA },

	{ "wxcststw-b0500.u9",	0x0400000, 0x6d08b15b, 4 | BRF_GRA },
	{ "pgm_b0501.u10",		0x0400000, 0x1546c2e9, 4 | BRF_GRA },
	{ "pgm_b0502.u15",		0x0400000, 0xe97b31c3, 4 | BRF_GRA },
	{ "wxcststw-b0503.rom",	0x0800001, 0xa1c8e5ba, 4 | BRF_GRA },
...
STDROMPICKEXT(olds100awxcststw, olds100awxcststw, pgm)
STD_ROM_FN(olds100awxcststw)

struct BurnDriver BurnDrvOlds100awxcststw = {
	"olds100awxcststw", "olds100a", "pgm", NULL, "2023-02-28",
	"Oriental Legend Special - Wu Zhi Shuang Mo\0", NULL, "IGS", "PolyGame Master",
	L"\u897F\u6E38\u91CA\u5384\u4F20 Super - \u4E94\u884C\u4F20\u8BF4 \u5510\u50E7\u5929\u738B [2023-02-28]\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM, GBF_SCRFIGHT, 0,
	NULL, olds100awxcststwRomInfo, olds100awxcststwRomName, NULL, NULL, NULL, NULL, pgmInputInfo, oldsDIPInfo,
	oldsInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};
...
struct BurnDriver BurnDrvOlds100awzsm = {
	"olds100ahack", "olds100a", "pgm", NULL, "2023-02-28",
	"Oriental Legend Special - Wu Zhi Shuang Mo\0", NULL, "IGS", "PolyGame Master",
...
struct BurnDriver BurnDrvKovshwzzz2014 = {
	"kovshwzzz", "kovsh", "pgm", NULL, "2014-05-27",
...
struct BurnDriver BurnDrvKovshwzzz2015 = {
	"kovshwzzz", "kovsh", "pgm", NULL, "2015-10-13",
	"Knights of Valour Superheroes / Sangoku Senki Superheroes (King War)\0", NULL, "IGS", "PolyGame Master",
...
struct BurnDriver BurnDrvKovshwzzzwj1b = {
	"kovshwzzz", "kovsh", "pgm", NULL, "2014-07-02",
...
static INT32 KovshxsInit()
{
	...
	if (nRet == 0) Kovshxssoundpatch();		//解决必杀多放几次声音就有毛病 的问题

	return nRet;
}

struct BurnDriver BurnDrvKovshxs = {
	"kovshzscs", "kovsh", "pgm", NULL, "2021-03-31",
...
struct BurnDriver BurnDrvKovshzsslwd = {
	"kovshzscs", "kovsh", "pgm", NULL, "2021-04-13",
...
// Knights of Valour Superheroes / Sangoku Senki Superheroes (ZhuLuZhongYuan)

static struct BurnRomInfo kovshzlzyRomDesc[] = {
	{ "zlzy-p0600.322",	0x0400000, 0x05cb05f4, 1 | BRF_PRG | BRF_ESS },
	...
	{ "pgm_a0602.u5",	0x0800000, 0xe7a32959, 3 | BRF_GRA },
	{ "pgm_a0613.u7",	0x0400000, 0xec31abda, 3 | BRF_GRA },
	{ "zlzy-a0604.rom",	0x0400000, 0x17a67ffa, 3 | BRF_GRA },

	{ "pgm_b0600.u6",	0x0800000, 0x7d3cd059, 4 | BRF_GRA },
	{ "pgm_b0601.u8",	0x0400000, 0xa0bb1c2f, 4 | BRF_GRA },
	{ "zlzy-b0602.rom",	0x0100000, 0x1f79f118, 4 | BRF_GRA },
	{ "zlzy-b0603.rom",	0x0800000, 0xd9da8cba, 4 | BRF_GRA },

	{ "pgm_m0600.u4",	0x0400000, 0x3ada4fd6, 5 | BRF_SND },

	{ "zlzy-v100_china.asic",	0x0004000, 0x5c1c9305, 7 | BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvKovshzlzy = {
	"kovshzlzy", "kovsh", "pgm", NULL, "2018-01-01",
	"Knights of Valour Superheroes / Qun Xiong Zhu Lu (ZhuLuZhongYuan)\0", NULL, "IGS", "PolyGame Master",
	L"\u4E09\u56FD\u6218\u7EAA - \u9010\u9E7F\u4E2D\u539F [2018-01-01]\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
	NULL, kovshzlzyRomInfo, kovshzlzyRomName, NULL, NULL, NULL, NULL, pgmInputInfo, kov115DIPInfo,
	kovshInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};

// Knights of Valour Superheroes / Sangoku Senki Superheroes (Jue Zhang Tian Xia)

static struct BurnRomInfo kovshzlzyjztxRomDesc[] = {
	{ "jztx-p0600.322",	0x0400000, 0x58e08538, 1 | BRF_PRG | BRF_ESS },
...
STDROMPICKEXT(kovshzlzyjztx, kovshzlzyjztx, pgm)
STD_ROM_FN(kovshzlzyjztx)

struct BurnDriver BurnDrvKovshzlzyjztx = {
	"kovshzlzy", "kovsh", "pgm", NULL, "2018-12-02",
	"Knights of Valour Superheroes / Qun Xiong Zhu Lu (Jue Zhang Tian Xia)\0", NULL, "IGS", "PolyGame Master",
	L"\u4E09\u56FD\u6218\u7EAA - \u9010\u9E7F\u4E2D\u539F \u51B3\u6218\u5929\u4E0B [2018-12-02]\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
	NULL, kovshzlzyjztxRomInfo, kovshzlzyjztxRomName, NULL, NULL, NULL, NULL, pgmInputInfo, kov115DIPInfo,
	kovshInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};

// Knights of Valour Superheroes / Sangoku Senki Superheroes (MoYeChuanShuo)

static struct BurnRomInfo kovshzlzymyRomDesc[] = {
	{ "my-p0600.322",	0x0400000, 0x21bffcf1, 1 | BRF_PRG | BRF_ESS },
...
struct BurnDriver BurnDrvKovshzlzymy = {
	"kovshzlzy", "kovsh", "pgm", NULL, "2019-01-02",
	"Knights of Valour Superheroes / Qun Xiong Zhu Lu (MoYeChuanShuo)\0", NULL, "IGS", "PolyGame Master",
	L"\u4E09\u56FD\u6218\u7EAA - \u9010\u9E7F\u4E2D\u539F \u83AB\u90AA\u4F20\u8BF4 [2019-01-02]\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
	NULL, kovshzlzymyRomInfo, kovshzlzymyRomName, NULL, NULL, NULL, NULL, pgmInputInfo, kov115DIPInfo,
	kovshInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};

// Knights of Valour Superheroes / Sangoku Senki Superheroes (Wu Jian)

static struct BurnRomInfo kovshzlzywjRomDesc[] = {
	{ "wj-p0600.322",	0x0400000, 0x328c615a, 1 | BRF_PRG | BRF_ESS },
...
struct BurnDriver BurnDrvKovshzlzywj = {
	"kovshzlzy", "kovsh", "pgm", NULL, "2019-09-07",
	"Knights of Valour Superheroes / Qun Xiong Zhu Lu (Wu Jian)\0", NULL, "IGS", "PolyGame Master",
	L"\u4E09\u56FD\u6218\u7EAA - \u9010\u9E7F\u4E2D\u539F \u4E94\u5251\u4F20\u5947 [2019-09-07]\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
	NULL, kovshzlzywjRomInfo, kovshzlzywjRomName, NULL, NULL, NULL, NULL, pgmInputInfo, kov115DIPInfo,
	kovshInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};

// Knights of Valour Superheroes / Sangoku Senki Superheroes (Wu Jian Boss)

static struct BurnRomInfo kovshzlzywjbossRomDesc[] = {
	{ "wjboss-p0600.322",	0x0400000, 0x1b1e38fe, 1 | BRF_PRG | BRF_ESS },

	{ "wjboss-t0600.u11",	0x0800000, 0xa919ec0f, 2 | BRF_GRA },
	...
	{ "wjboss-m0600.u4",	0x0400000, 0x7a50501b, 5 | BRF_SND },

	{ "zlzy-v100_china.asic",	0x0004000, 0x5c1c9305, 7 | BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(kovshzlzywjboss, kovshzlzywjboss, pgm)
STD_ROM_FN(kovshzlzywjboss)

struct BurnDriver BurnDrvKovshzlzywjboss = {
	"kovshzlzy", "kovsh", "pgm", NULL, "2018-12-28",
	"Knights of Valour Superheroes / Qun Xiong Zhu Lu (Wu Jian Boss)\0", NULL, "IGS", "PolyGame Master",
	L"\u4E09\u56FD\u6218\u7EAA - \u9010\u9E7F\u4E2D\u539F \u4E94\u5251\u4F20\u5947 BOSS\u7248 [2018-12-28]\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
	NULL, kovshzlzywjbossRomInfo, kovshzlzywjbossRomName, NULL, NULL, NULL, NULL, pgmInputInfo, kov115DIPInfo,
	kovshInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};

// Knights of Valour Superheroes / Sangoku Senki Superheroes (Wu Jian Zai Should Gold)

static struct BurnRomInfo kovshzlzywjzsjRomDesc[] = {
	{ "wjzsj-p0600.322",	0x0400000, 0x328c615a, 1 | BRF_PRG | BRF_ESS },

	{ "wjzsj-t0600.u11",	0x0800000, 0x4acc1ad6, 2 | BRF_GRA },
...
STDROMPICKEXT(kovshzlzywjzsj, kovshzlzywjzsj, pgm)
STD_ROM_FN(kovshzlzywjzsj)

struct BurnDriver BurnDrvKovshzlzywjzsj = {
	"kovshzlzy", "kovsh", "pgm", NULL, "2019-10-30",
	"Knights of Valour Superheroes / Qun Xiong Zhu Lu (Wu Jian)\0", NULL, "IGS", "PolyGame Master",
	L"\u4E09\u56FD\u6218\u7EAA - \u9010\u9E7F\u4E2D\u539F \u4E94\u5251\u5728\u624B \u9EC4\u91D1\u7248 [2019-10-30]\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
	NULL, kovshzlzywjzsjRomInfo, kovshzlzywjzsjRomName, NULL, NULL, NULL, NULL, pgmInputInfo, kov115DIPInfo,
	kovshInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};

// Knights of Valour Superheroes / Sangoku Senki Superheroes (Zhong Ji Tian Wang)
...
struct BurnDriver BurnDrvKovshzlzyzjtw = {
	"kovshzlzy", "kovsh", "pgm", NULL, "2019-04-15",
	"Knights of Valour Superheroes / Qun Xiong Zhu Lu (Zhong Ji Tian Wang)\0", NULL, "IGS", "PolyGame Master",
