...
struct BurnDriver BurnDrvElim2 = {
	...
	L"\u592A\u7A7A\u5C04\u51FB (2P \u7248, \u7B2C\u4E00\u5957)\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvElim2a = {
	...
	L"\u592A\u7A7A\u5C04\u51FB (2P \u7248, \u7B2C\u4E8C\u5957)\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvElim2c = {
	...
	L"\u592A\u7A7A\u5C04\u51FB (2P \u7248, \u5E73\u8EBA\u578B)\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_MISC, GBF_SHOOT | GBF_VECTOR, 0,
...
struct BurnDriver BurnDrvElim4p = {
	...
	L"\u592A\u7A7A\u5C04\u51FB (4P \u7248, \u5DE5\u7A0B\u7248)\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvZektor = {
	...
	L"\u592A\u7A7A\u8F6E\u5ED3\u6218\u673A (\u4FEE\u8BA2\u7248 B)\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_MISC, GBF_SHOOT | GBF_VECTOR, 0,
