...
struct BurnDriver BurnDrvEsprade = {
	...
	L"\u957F\u7A7A\u8D85\u5C11\u5E74 - \u4E1C\u4EAC A.D.2018 (\u4E16\u754C\u7248, 1998 4/22 \u56FD\u9645\u7248)\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvEspradej = {
	...
	L"\u957F\u7A7A\u8D85\u5C11\u5E74 (\u65E5\u7248, 1998 4/21 \u4E3B\u7248)\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvEspradejo = {
	...
	L"\u957F\u7A7A\u8D85\u5C11\u5E74 (\u65E5\u7248, 1998 4/14 \u4E3B\u7248)\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY | BDF_HISCORE_SUPPORTED, 2, HARDWARE_CAVE_68K_ONLY, GBF_VERSHOOT, 0,
...
static struct BurnRomInfo espradezqhlRomDesc[] = {
	{ "u42.bin",      0x080000, 0x3c9a58e6, BRF_ESS | BRF_PRG }, //  0 CPU #0 code
	{ "u41.bin",      0x080000, 0xf1b4bd9b, BRF_ESS | BRF_PRG }, //  1
...
STD_ROM_PICK(espradezqhl)
STD_ROM_FN(espradezqhl)

struct BurnDriver BurnDrvEspradezqhl = {
	"espradezqhl", "esprade", NULL, NULL, "1998",
	"ESP Ra.De. (Japan, 1998 4/14 Master Ver.)\0", NULL, "Cave (Atlus license)", "Cave",
	L"\u957F\u7A7A\u5C11\u5E74 - \u6700\u5F3A\u706B\u529B\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY | BDF_HISCORE_SUPPORTED, 2, HARDWARE_CAVE_68K_ONLY, GBF_VERSHOOT, 0,
	NULL, espradezqhlRomInfo, espradezqhlRomName, NULL, NULL, NULL, NULL, espradeInputInfo, espradeDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	&CaveRecalcPalette, 0x8000, 240, 320, 3, 4
};
